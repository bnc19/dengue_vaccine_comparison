...
# vaccines. The script is set up to run the final model (M21) using 1000 
# iterations. All other model variants presented in the manuscript can be run
# below. All model variants are run using the same stan model (final_model.stan) 
# with different parameters turned on and off, using the flags. 
...
n_it = 6000 ## NOTE: this can take several hours to run 6000 iterations 
